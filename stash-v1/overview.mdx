...
<Note>
  Issuing an asset with a settlement delay? Go to the [Asset Issuer quickstart](/quickstart/asset-issuer) — it covers onboarding, the two runtime calls, pricing and the integration models.
</Note>
