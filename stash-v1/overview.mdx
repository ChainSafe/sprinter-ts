...
| | **LI.FI Intents** | **Liquidity API** |
|---|---|---|
| **For** | Asset issuers, wallets, applications | Crosschain solvers running their own fill infrastructure |
| **You get** | A firm quote and a transaction to send | A borrow quote and an MPC-signed authorization |
| **You run** | Nothing — Sprinter builds the order and fills it | Your own fill and settlement |
| **Start at** | [`GET /lifi-intents/rfq`](/api-reference/sprinter/lifi-intents/rfq) | [Integration Guide](/stash-v1/integration-guide) |
