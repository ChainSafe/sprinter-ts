...
<CardGroup cols={2}>
  ...
  <Card title="Solve RFQ" icon="code" href="/api-reference/solve-rfq/overview">
    Get a firm, liquidity-backed quote through LI.FI Intents — or route a swap against public liquidity.
  </Card>
  <Card title="Sprinter Liquidity API" icon="database" href="/api-reference/sprinter/liquidity/overview">
    For solvers: discover available liquidity, quote a borrow, and get signing authorization.
  </Card>
</CardGroup>
