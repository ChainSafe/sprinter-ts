...
Two paths. The flow described here draws on **shared liquidity** and gets you live without a commercial agreement. A **dedicated facility** commits capacity to your flow and is agreed commercially — see [Pricing & Credit Facilities](/pricing) for both, and what a fill costs.
...
<Note>
  ...
  With a `quoteId`, this call refreshes the reservation to **60 seconds from the response** — that is the budget for signing and broadcasting, not the 15 seconds the quote had.
</Note>
